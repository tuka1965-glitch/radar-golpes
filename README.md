...
- Base inicial de fraudes conhecidas da RNP/CAIS em `data/fraudes-rnp.json`, gerada por `tools/build_rnp_fraud_base.py`.
...
```powershell
python .\tools\build_rnp_fraud_base.py --limit 100 --max-pages 20 --delay 0.2 --insecure-tls
```
